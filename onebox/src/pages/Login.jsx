            ...
            <div className=' m-auto w-[460px] h-auto md:h-[312px]  bg-[#111214] rounded-2xl border border-gray-700  py-6  px-10 '>
                <div className=' w-[380px] m-auto'>
                    ...
                    <div className='rounded border border-gray-500 h-12 flex justify-center items-center gap-2.5  mb-12'>
                        ...
                        <Link  to="https://hiring.reachinbox.xyz/api/v1/auth/google-login?redirect_to=https://one-box-ebon.vercel.app/home" className='text-sm text-gray-400 cursor-pointer' onClick={handleclick}> Sign Up with Google </Link>
                    </div>
                    <p className='w-[195px] h-12 bg-[#3d65ea] rounded m-auto text-center pt-2.5 mb-6 cursor-pointer'>Create an account</p>
                    <p className='text-base text-gray-500 ml-20'>Already have an account? <span style={{cursor:'pointer'}}>Sign In</span></p>
                </div>
